...
layui.define('layer', function(exports){
  ...
  ,Form = function(){
    this.config = {
      verify: {
        ...
        ,date: [
          /^(\d{4})[-\/](\d{1}|0\d{1}|1[0-2])([-\/](\d{1}|0\d{1}|[1-2][0-9]|3[0-1]))*( (20|21|22|23|[0-1][0-9]):[0-5][0-9]:[0-5][0-9])*$/
          ,'日期格式不正确'
        ]
        ,identity: [
          /(^\d{15}$)|(^\d{17}(x|X|\d)$)/
  ...
  var submit = function(){
    ...
    layui.each(verifyElem, function(_, item){
      var othis = $(this), ver = othis.attr('lay-verify'), tips = '', def_tips = othis.attr('lay-tips');
      ...
      if(verify[ver] && (isFn ? tips = verify[ver](value, item) : !verify[ver][0].test(value)) ){
        layer.msg(def_tips || tips || verify[ver][1], {
          icon: 5
          ,shift: 6
        });
        //非移动设备自动定位焦点
